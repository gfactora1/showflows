...
export default function ShowDetail({ show, projectId, myRole, onBack }: Props) {
  ...
  const toggleConfirmed = async (assignment: Assignment) => {
    ...
    const newValue = !assignment.is_confirmed
                  ...
                  <td style={{ padding: 8, borderBottom: '1px solid #f0f0f0' }}>
                    {canEdit ? (
                      ...
                      <span style={{
                        ...
                        padding: '3px 8px',
                        borderRadius: 20,
                        background: a.is_confirmed ? '#edfff3' : '#f5f5f5',
                        color: a.is_confirmed ? '#1a7a3a' : '#888',
                        border: `1px solid ${a.is_confirmed ? '#b2f0c8' : '#e5e5e5'}`,
                      }}>
